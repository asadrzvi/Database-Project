  ...
  <body>
    <div class="container">
      ...
      ?>
        ...
        from tracks
        where DateCreate between DATE_SUB(curdate(), INTERVAL 1 week) AND curdate();";
        $result =mysqli_query($conn,$sql);
        $resultCheck= mysqli_num_rows($result);

        if($resultCheck>0)
        {
          echo "<br>" . "Total number of songs added in the past week  = ". $resultCheck . "<br>";
          echo "<table border='1'>";
          ...
          echo "<br>" . "No songs uploaded in the past week";
        }
